...
const D = {
  ...
  mods: {
    seo: {
      ...
      categories: [
        ...
        },
        {
          ...
          intro:
            "This is the most critical score in the audit. With Google's mobile-first indexing, a 38/100 mobile score is actively suppressing rankings. Two checks failed — fix these in Week 1.",
          checks: [
            {
            ...
            },
            {
              ...
              priority: "MEDIUM",
              action: "Ensure all tap targets are at least 44x44px",
            },
            {
        ...
        },
        {
          ...
          // ADDED FROM WORD DOC: intro paragraph for this category
          intro:
            "All key backlink metrics passed. Strong domain authority is a competitive advantage. Continue earning links through original research, thought leadership, and digital PR. Monitor for toxic backlinks monthly.",
          checks: [
            {
              n: "Domain Authority",
              status: "PASS",
    ...
    aeo: {
      ...
      intro:
        "AEO score: 79/100 — the strongest overall section. Specific gaps in schema implementation and trust signals require attention to push toward 90+.",
      categories: [
        {
        ...
        },
        {
          ...
          // ADDED FROM WORD DOC: intro paragraph for this category
          intro:
            "Voice Search optimization is perfect. The site uses conversational keywords, full question phrases, local signals, and Speakable schema. Maintain this standard across all new content published.",
          checks: [
            {
        ...
        },
        {
          ...
          // ADDED FROM WORD DOC: intro paragraph for this category
          intro:
            "NLP and semantic optimization are strong. Content is written in natural language and covers entities and related terms comprehensively. One warning: ensure first mentions of key entities are hyperlinked to authoritative external sources.",
          checks: [
            {
    ...
    geo: {
      ...
      // ADDED FROM WORD DOC: module-level intro
      intro:
        "GEO score: 72/100. Good foundation but critical gaps in brand consistency, security signals, and metadata are limiting AI citability. GEO optimizes for visibility within ChatGPT, Google AI Overview, Perplexity, and Bing Copilot.",
      categories: [
        {
          ...
          // ADDED FROM WORD DOC: intro paragraph for this category
          intro:
            "Content is largely well-structured for AI parsing. Key action: start every page with a 2-3 sentence summary paragraph — AI systems read top-of-page content first when generating answers.",
          checks: [
            {
...
const CALENDAR = [
  {
    ...
    focusText:
      "Focus: Establish core service pages, launch first definition piece for SEO, begin FAQ-style content. Align with on-page SEO repairs happening in parallel.",
    items: [
      {
        week: "W1",
        dates: "Apr 1–5",
  ...
  },
  {
    ...
    // ADDED FROM WORD DOC: month focus paragraph
    focusText:
      "Focus: AEO content push. Publish the AEO definition piece, launch the first case study for E-E-A-T, build the first FAQ page for People Also Ask capture.",
    items: [
      {
        week: "W5",
        dates: "Apr 28–May 3",
  ...
  },
  {
    ...
    // ADDED FROM WORD DOC: month focus paragraph
    focusText:
      "Focus: GEO awareness and niche verticals. Publish the GEO explainer piece and first use case page. Second case study for E-E-A-T.",
    items: [
      {
        week: "W10",
        dates: "Jun 2–7",
  ...
  },
  {
    ...
    // ADDED FROM WORD DOC: month focus paragraph
    focusText:
      "Focus: Thought leadership and conversion-focused content. Push service pages for competitive keywords. Build internal authority linking.",
    items: [
      {
        week: "W14",
        dates: "Jun 30–Jul 5",
  ...
  },
  {
    ...
    // ADDED FROM WORD DOC: month focus paragraph
    focusText:
      "Focus: Local SEO reinforcement and brand trust. Optimize GBP, publish third case study, target SaaS and B2B verticals.",
    items: [
      {
        week: "W19",
        dates: "Aug 4–9",
  ...
  },
  {
    ...
    // ADDED FROM WORD DOC: month focus paragraph
    focusText:
      "Focus: Authority consolidation and 2027 forward positioning. Refresh content, build schema depth, publish the annual thought leadership piece.",
    items: [
      {
        week: "W24",
        dates: "Sep 8–13",
...
function buildKeywords() {
  ...
  html += kwTable(
    ...
    "Lower competition keywords targeting AEO/GEO gaps — missing FAQ sections, definition pages, and People Also Ask opportunities.",
    KW.longtail,
  );
  html += kwTable(
  ...
  html += kwTable(
    ...
    "Target international clients looking to outsource digital marketing from India. Strong backlink profile (90/100) gives the domain authority to compete globally.",
    KW.global,
  );
...
function addDividerPage(pdf, name, num, total, W, H) {
  ...
  pdf.setFont("helvetica", "normal");
  pdf.text(
    "SEO + AEO + GEO Audit Report  \u00B7  codewithck.me  \u00B7  19 March 2026",
    18,
    158,
  );
}
...
async function capturePanel(panel) {
  ...
  // Expand all categories inside this panel
  panel.querySelectorAll(".cat-section").forEach(function (c) {
  ...
  var canvas = await html2canvas(panel, {
    ...
    onclone: function (doc, el) {
      ...
      doc.querySelectorAll(".cat-section").forEach(function (c) {
        c.classList.add("open");
      });
    },
  });
...
function addPageFooter(pdf, A4_W, A4_H, pageNum, totalPages, MARGIN_BOTTOM) {
  ...
  pdf.setFont("helvetica", "normal");
  pdf.text(
    "codewithck.me  \u00B7  SEO + AEO + GEO Audit 2026",
    10,
    footerY + 6,
  );
...
function addPageFooter_UNUSED(ctx, w, h, pageNum, totalPages) {
  ...
  ctx.fillStyle = "#9ba3af";
  ctx.fillText(
    "codewithck.me  \u00B7  SEO + AEO + GEO Audit 2026  \u00B7  Page " +
      pageNum +
      " of " +
      totalPages,
    20,
...
async function exportPDF() {
  ...
  try {
    ...
    var domain = (
      document.getElementById("bc-domain")
        ? document.getElementById("bc-domain").textContent
        : "audit"
    ).replace(/[^a-z0-9.-]/gi, "-");
    var dateStr = new Date().toISOString().split("T")[0];
    pdf.save(domain + "-seo-aeo-geo-full-report-" + dateStr + ".pdf");
...
function addCoverPage(pdf, W, H) {
  ...
  var parts = [
    ...
    },
    {
      ...
      detail: "29 content pieces · Apr–Oct 2026",
    },
    {
      num: "PART 3",
      title: "SEO Strategy, Competitors & Keywords",
      detail: "12-month plan · 6 competitors · 62 keywords",
    },
  ];
  var py = 180;
  parts.forEach(function (p) {
  ...
  pdf.setTextColor(255, 255, 255);
  pdf.text(
    "Generated by BuimbDigital  \u00B7  19 March 2026  \u00B7  CONFIDENTIAL",
    18,
    H - 2,
  );
}
